local mask_table = {}
mask_table.ne_sw_hall = wesnoth.dofile("~add-ons/Wesband-z/masks/ne_sw_hall.lua")
mask_table.nw_se_hall = wesnoth.dofile("~add-ons/Wesband-z/masks/nw_se_hall.lua")
